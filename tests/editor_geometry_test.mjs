...
assert.ok(html.includes('#quickShapes,#quickSfx,#quickStamps,#quickFrames { grid-template-columns:repeat(2,minmax(0,1fr)); }'));
...
assert.ok(html.includes('function canvasHitEnabled(item){return Boolean(item)&&item.type!=="frame";}'));
